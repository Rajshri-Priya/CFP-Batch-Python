...
def delete_contact(contacts):
    ...
    contacts[:] = [contact for contact in contacts if not (contact['first_name'] == first_name and contact['last_name'] == last_name)]
...
def main():
    # addressbook=[contacts1[dict1{},dict2{},dict3{}],contacts2[dict1{},dict2{},dict3{}],contacts3[dict1{},dict2{},dict3{}]...]
    # contacts = []
    flag = True
    while flag:
